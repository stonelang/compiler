#ifndef CLANG_INLINE_BITFIELD_H
#define CLANG_INLINE_BITFIELD_H
...
/// CLANG_INLINE_BITFIELD(Foo, Bar, 1+3+7+2, w:1, x:3, y:7, z:2);
...
#define CLANG_INLINE_BITFIELD_BASE(T, C, ...)                                  \
  LLVM_PACKED_START                                                            \
  class T##Bitfield {                                                          \
    friend class T;                                                            \
...
#define CLANG_INLINE_BITFIELD_TEMPLATE(T, U, C, HC, ...)                       \
  LLVM_PACKED_START                                                            \
  class T##Bitfield {                                                          \
    friend class T;                                                            \
...
#define CLANG_INLINE_BITFIELD(T, U, C, ...)                                    \
  CLANG_INLINE_BITFIELD_TEMPLATE(T, U, C, 0, __VA_ARGS__)
...
///
/// CLANG_INLINE_BITFIELD_FULL(Foo, Bar, 1+8+16,
///   flag : 1,
///   : NumPadBits, // pad the center, not the end
///   x : 8,
///   y : 16
/// );
#define CLANG_INLINE_BITFIELD_FULL(T, U, C, ...)                               \
  LLVM_PACKED_START                                                            \
  class T##Bitfield {                                                          \
    friend class T;                                                            \
...
#define CLANG_INLINE_BITFIELD_FULL_TEMPLATE(T, U, C, ...)                      \
  LLVM_PACKED_START                                                            \
  class T##Bitfield {                                                          \
...
#define CLANG_INLINE_BITFIELD_EMPTY(T, U) enum { Num##T##Bits = Num##U##Bits }
