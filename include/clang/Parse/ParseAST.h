...
namespace clang {
  ...
  void ParseAST(Sema &sem, bool printStats = false, bool skipFunctionBodies = false);

  /// Parse the main file known to the preprocessor, producing an
  /// abstract syntax tree.
  void ParseAST(SourceFile& sourceFile, Sema &sem, bool printStats = false, bool skipFunctionBodies = false);
